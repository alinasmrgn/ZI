    ...
    public static class ECDSA
    {
        ...
        public static bool VerifySignature(BigInteger data, Dott openKey, Dott signature, Dott baseDott, EllipticCurve curve)
        {
            ...
            if (AreNumbersCoprime(signature.y, curve.order))
            {
                ...
                Dott left = Dott.DottMultiplication(baseDott, u, curve);
                //Console.WriteLine("left dott");
                //Program.ShowDott(left);

                Dott right = Dott.DottMultiplication(openKey, v, curve);
                //Console.WriteLine("right dott");
                //Program.ShowDott(right);

                Dott dott = Dott.Addition(left, right, curve);
                //Console.WriteLine("dott");
                //Program.ShowDott(dott);
                //if (signature.x != (dott.x % curve.order))
                //{
                //    Console.WriteLine("Base dott");
                //    Program.ShowDott(baseDott);
                //    Console.WriteLine("Open key");
                //    Program.ShowDott(openKey);
                //    Console.WriteLine("Signature");
                //    Program.ShowDott(signature);
                //    Console.WriteLine("w = " + w);
                //    Console.WriteLine("u = " + u);
                //    Console.WriteLine("v = " + v);
                //    Console.WriteLine("left dott");
                ...
                //    Console.WriteLine("dott");
                //    Program.ShowDott(dott);
                //    Console.WriteLine("signature.x = " + signature.x);
                //    Console.WriteLine("dott.x      = " + dott.x % curve.order);
                //}
                stopWatch.Stop();
                verifySignatureTicks.Add(stopWatch.ElapsedTicks);
                //Console.WriteLine("VerifySignature Ticks   " + stopWatch.ElapsedTicks);
                //Console.WriteLine("VerifySignature Seconds " + stopWatch.Elapsed);
